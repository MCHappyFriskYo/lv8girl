...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .preview-img { max-width: 100%; max-height: 150px; border-radius: 16px; margin-top: 10px; }
    ...
    <div class="form-card">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="file-hint" style="font-size:12px; color:#8bb282;">若不提供，将自动从视频第一帧提取封面（需服务器支持 FFmpeg）</div>
    ...
    <div>
        <div class="tips-card">
            ...
            <ul class="tips-list">
                ...
                <li><i class="fas fa-check-circle" style="color:#6fcf97;"></i> 建议使用 H.264 编码的 MP4 获得最佳兼容性</li>
