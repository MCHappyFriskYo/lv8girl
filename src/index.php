...
// 读取公告 已修复 t_realname 错误，使用 username
$noticeSt = $pdo->query("
SELECT n.content, t.username, n.create_time 
FROM notice n 
LEFT JOIN cho_user t ON n.create_tid = t.id 
                ...
                <?php else: ?>
                    ...
                    <li class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-textSub mt-1">发布人：<?=htmlspecialchars($nt['username']) ?> · <?= $nt['create_time'] ?></p>
                        </div>
                    </li>
                    <?php endforeach; ?>
                <?php endif; ?>
